...
class DatabaseDynamoDBSingleTable extends import_abstracts.AwsConstruct {
  constructor(scope, id, configuration, provider) {
    ...
    this.tableNameOutput = new import_core.CfnOutput(this, "TableName", {
  ...
  permissions() {
    return [
      new import_CloudFormation.PolicyStatement([
        ...
        "dynamodb:UpdateItem"
      ], [this.table.tableArn, import_core.Stack.of(this).resolve(import_core.Fn.join("/", [this.table.tableArn, "index", "*"]))])
    ];
  }
  outputs() {
    return {
