...
class Storage extends import_abstracts.AwsConstruct {
  ...
  permissions() {
    return [
      new import_CloudFormation.PolicyStatement(["s3:PutObject", "s3:GetObject", "s3:DeleteObject", "s3:ListBucket"], [this.bucket.bucketArn, import_core.Stack.of(this).resolve(import_core.Fn.join("/", [this.bucket.bucketArn, "*"]))])
    ];
  }
  outputs() {
    return {
