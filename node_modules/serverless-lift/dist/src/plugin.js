...
Find all construct types available here: https://github.com/getlift/lift#constructs`, "LIFT_UNKNOWN_CONSTRUCT_TYPE");
  ...
  resolveLazyVariables() {
    const tokenResolver = new import_core.DefaultTokenResolver(new import_core.StringConcat());
    const resolveTokens = (input) => {
      if (input === void 0) {
        return input;
      }
      return import_core.Tokenization.resolve(input, {
